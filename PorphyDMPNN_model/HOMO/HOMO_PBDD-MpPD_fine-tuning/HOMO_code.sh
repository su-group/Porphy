...
# transfer 
chemprop_train --data_path MpPD.csv --dataset_type regression --save_dir HOMO_transfer --split_size 0.8 0.1 0.1 --checkpoint_dir PBDD_HOMO --dropout 0.2 --target_columns HOMO --epochs 20  --gpu 0 --seed 0 

chemprop_predict --test_path HOMO_transfer/fold_0/train_smiles.csv --checkpoint_dir HOMO_transfer --preds_path HOMO_transfer/fold_0/train_predict.csv
chemprop_predict --test_path HOMO_transfer/fold_0/val_smiles.csv --checkpoint_dir HOMO_transfer --preds_path HOMO_transfer/fold_0/val_predict.csv
chemprop_predict --test_path HOMO_transfer/fold_0/test_smiles.csv --checkpoint_dir HOMO_transfer --preds_path HOMO_transfer/fold_0/test_predict.csv
